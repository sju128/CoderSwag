...
object DataService {
    ...
    val hats = listOf(
        Product("Devlslopes Graphic Beanie", "$18", "hat01"),
        Product("Devlslopes Hat Black", "$20", "hat02"),
        Product("Devlslopes Hat White", "$18", "hat03"),
        Product("Devlslopes Hat Snapback", "$22", "hat04")
    )
